      ...
      <div className="relative h-[80vh] max-w-[850px] overflow-x-auto mt-4 border border-gray-400 scrollbar-hide">
                <table className="w-full text-sm border border-black  text-gray-500">
                    <thead className="text-xs text-gray-700 text-left uppercase bg-gray-50">
                        <tr>
                            <th scope="col" className="hidden text-md sm:block border border-black px-6 py-3">
                                Author name
                            </th>
                            <th scope="col" className="px-6  text-md border-2 border-black py-3">
                                Blog Title
                            </th>
                            <th scope="col" className="px-6 text-md border-2 border-black py-3">
                                Date
                            </th>
                            <th scope="col" className="px-2  text-md border-2 border-black py-3">
                                Action
                            </th>
                        </tr>
                    </thead>
